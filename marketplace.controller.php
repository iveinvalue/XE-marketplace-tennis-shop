...
class marketplaceController extends marketplace
{
	...
	private function _insertMarketItem($obj) 
	{
		...
		$args->seller_contact = removeHackTag($obj->seller_contact);
		$args->size1 = removeHackTag($obj->size1);
		$args->size2 = removeHackTag($obj->size2);
		
		$args->string1 = removeHackTag($obj->string1);
		$args->string2 = removeHackTag($obj->string2);
		$args->frame1 = removeHackTag($obj->frame1);
		$args->frame2 = removeHackTag($obj->frame2);
		$args->frame3 = removeHackTag($obj->frame3);
		$args->length = removeHackTag($obj->length);
		$args->g_size = removeHackTag($obj->g_size);
		
		$args->product_name = removeHackTag($obj->item_name);
		$args->product_name2 = removeHackTag($obj->item_name2);
	...
	function procMarketplaceItemModify()
	{
		...
		$args->seller_contact = $obj->seller_contact;
		$args->size1 = $obj->size1;
		$args->size2 = $obj->size2;
		
		$args->string1 = $obj->string1;
		$args->string2 = $obj->string2;
		$args->frame1 = $obj->frame1;
		$args->frame2 = $obj->frame2;
		$args->frame3 = $obj->frame3;
		$args->length = $obj->length;
		$args->g_size = $obj->g_size;
		
		$args->product_name = $obj->item_name;
		$args->product_name2 = $obj->item_name2;
